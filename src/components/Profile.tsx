                        ...
                        {userInfo && (
                            <>
                                ...
                                <div className="profile-details">
                                    ...
                                    {userInfo.gender && (
                                        <span className="profile-detail">Gender: {userInfo.gender.charAt(0).toUpperCase() + userInfo.gender.slice(1).toLowerCase()}</span>
                                    )}
                                    {userInfo.zodiac && (
                                        <span className="profile-detail">Zodiac: {formatZodiac(userInfo.zodiac)}</span>
                                    )}
                                </div>
                            </>
                        )}
